...
const Kanban = () => {
                ...
                <p>
                  ...
                  {ticket.lastMessage.length > 50 ? (
                    <>
                      ...
                      <Button onClick={() => setMoremessage(ticket.lastMessage)}>Ver mais</Button>
                    </>
                  ) : (
                    ticket.lastMessage || " "
                  )}
                </p>
                {moreMessage === ticket.lastMessage && (
                  <div style={{ transition: 'all 0.3s ease' }}>
                    <p>{ticket.lastMessage}</p>
                    <Button onClick={() => setMoremessage(null)}>Ver menos</Button>
                  </div>
                )}
                <Button
                  className={`${classes.button} ${classes.cardButton}`}
  ...
  return (
    <div className={classes.root}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px', width: '90%', maxWidth: '1200px' }}>
