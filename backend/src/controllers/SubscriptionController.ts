...
export const createSubscription = async (
  ...
  if (!(await schema.isValid(req.body))) {
    throw new AppError("erro de validação de dados", 400);
  }
  ...
  try {
    ...
    throw new AppError("Erro ao criar a assinatura", 400);
  }
};
...
export const createWebhook = async (
  ...
  if (!(await schema.isValid(req.body))) {
    throw new AppError("erro de validação ao criar o webhook", 400);
  }
